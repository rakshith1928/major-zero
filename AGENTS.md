...
- **Seed is deterministic** (`seed/buses.py`): 34 bus templates, corridors BLR↔Chennai + BLR↔Hyderabad (Vellore/Kurnool midpoints). Stats shown in UI must come from seed/code, never invented.
