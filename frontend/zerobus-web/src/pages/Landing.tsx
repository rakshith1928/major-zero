      ...
      <header className="zb-hero">
        <div className="zb-hero-copy">
          ...
          <dl className="zb-hero-stats">
            <div><dt className="sr-only">Buses in the demo inventory</dt><dd><strong>34</strong><span>buses</span></dd></div>
            <div><dt className="sr-only">Corridors served</dt><dd><strong>2</strong><span>corridors</span></dd></div>
