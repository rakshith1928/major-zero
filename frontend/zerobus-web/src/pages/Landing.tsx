...
export default function Landing() {
  ...
  return (
    <div className="zb-landing" ref={rootRef}>
      ...
      <div className="zb-tagline zb-reveal">
        <BusArt width={150} />
        <div className="min-w-0">
          <p>Skip the counter. Your seat is one chat away.</p>
          <Link to="/chat" className="zb-button zb-button-amber mt-3 inline-flex">Start booking <Icon name="arrow" /></Link>
        </div>
      </div>
      ...
      <aside className="zb-disclosure"><span className="zb-badge shrink-0">Research prototype</span><p>Bus inventory and tracking are simulated. Payments use Razorpay test mode — no real money. Passenger intent uses a fine-tuned MiniLM model in local development (93.9% held-out accuracy) with rule-based fallback in the hosted demo. This is a student research project, not a live transport service.</p></aside>
    </div>
  );
}
